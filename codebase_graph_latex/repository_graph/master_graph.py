...
MODERATE_FOUNDER_COLOUR = 'Purple'
MODERATE_JOINER_COLOUR = 'Cyan'
TRANSIENT_JOINER_COLOUR = 'Orange'
SUSTAINED_JOINER_COLOUR = 'Red'

FIGURE_CAPTION_NUMBERS = "samples of developers capped at NUM4 sustained later joiners from six (6) categories: "
...
FIGURE_CAPTION_NUMBERS += "\\color{" + TRANSIENT_JOINER_COLOUR + "}" " " + TRANSIENT_JOINER.title() + " (" + TRANSIENT_JOINER_COLOUR + ", NUM4), "
FIGURE_CAPTION_NUMBERS += "\\color{" + MODERATE_JOINER_COLOUR + "}" + MODERATE_JOINER.title() + " (" + MODERATE_JOINER_COLOUR + ", NUM5), "
FIGURE_CAPTION_NUMBERS += "\\color{" + SUSTAINED_JOINER_COLOUR + "}" " " + SUSTAINED_JOINER.title() + " (" + SUSTAINED_JOINER_COLOUR + ", NUM6). "
